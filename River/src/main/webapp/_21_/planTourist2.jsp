						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb" style="width:100% ;">
									<div class="item-slick3" data-thumb="../images/TAimages/defaultTAImage.jpg" >
										<div class="wrap-pic-w pos-relative" >
											<img name="imgmodal" src="../images/TAimages/defaultTAImage.jpg" alt="IMG-PRODUCT"style=" width:100%" >

											<a  class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../images/TAimages/defaultTAImage.jpg">
...
// 					"address" : pacinputv
// 				}, function(taLatLng) {
// 					console.log(taLatLng)
// // 					var location = $.parseJSON(taLatLng);
// 					$('#lat').val(taLatLng.lat)
// 					$('#lng').val(taLatLng.lng)
...
// 					  url:'LoadTALatLng',
// 					  type:"get",
// 					  data:{"address" : pacinputv},
// 					  contentType:'application/x-www-form-urlencoded; charset=UTF-8',
// 					  dataType:'json',
// 					  responseType:'application/json',
// 					  success: function(taLatLng){
// // 						  var location = $.parseJSON(taLatLng);
// 							console.log(taLatLng)
// 		 					$('#lat').val(taLatLng.lat);
// 		 					$('#lng').val(taLatLng.lng);
...
// 		    		alert(ihtml)
		    	    ...
		    	    $(this).parents(".draggableti").find(".countta").each(function(){
		    	    	var location=""
						//取得景點名稱
						var lat= $(this).find(".TAlat").html()
						var lng= $(this).find(".TAlng").html()
						location=lat+","+lng
						dayti.push(location)
						})
						console.log(dayti)
