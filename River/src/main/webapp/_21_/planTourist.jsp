											...
											function(taList) {
												...
												json
														.forEach(function(TA) {
															...
															txt += '<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women"><div class="block2"><div class="block2-pic hov-img0">'

															txt += '<img src="${pageContext.servletContext.contextPath}/getTAImage?id='
																	+ TA.id
																	+ '" alt="IMG-PRODUCT">'
															...
															txt += '</a> <span class="stext-105 cl3">'
																	+ TA.touristarea
