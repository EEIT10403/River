				...
				<div class="row">
					<div class="col-md-12">
						<div class="card text-white bg-info">
							<h5 class="card-header">使用日期</h5>
							<div class="card-body">
								<p class="card-text ">單位: 新台幣/元</p>
							...
							<span id='ticketQty'>共計 0 張</span>
							<span id='totalPrice'>共計 0 元</span></div>
						</div>
						...
						<a href="#" class="btn btn-lg btn-secondary btn-block"
...
function totalPrice() {
	...
	$('#totalPrice').html('共計 '+ totalPrice +' 元');
